...
<div class="blog-content-page content-block">
	...
	<ul class="breadcrumb__list" itemscope="" itemtype="http://schema.org/BreadcrumbList" >
		...
		<li itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem" class="breadcrumb__list-item is--active">Блог компании</li>
	</ul>
</div>		
		<div class="heading-page__hgroup _bcp__heading-page__hgroup">
			<h1 class="_bcp__heading heading-page line"><span>Поиск `<?=get_search_query();?>`</span></h1>	
		</div>
	</div>
