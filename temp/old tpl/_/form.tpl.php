<form action="" class="form-site <?=$param["class"];?> azbn-cbk-form "  >
	...
	<div class="row <?=$param["prefix_form"];?>row">
		...
		*/
		...
		<div class="cols <?=$param["prefix_form"];?>cols">
			<div class="<?=$param["prefix_form"];?>item">
				<input type="tel" class="<?=$param["prefix_form"];?>control form-control validate[required,custom[phone]] azbn-cbk-form__phone" id="f[tel]" name="f[Телефон]" placeholder="Телефон"> 
			</div>	
		</div>
